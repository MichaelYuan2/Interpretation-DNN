...
def plot_loss(epochs, train_losses, test_losses, fp = 'plot'):
    ...
    plt.grid()
    plt.title('Loss Curves_random')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()

    plt.tight_layout()
    plt.savefig(os.path.join(fp, "Loss_Curves_random.png"))
    plt.clf()
...
def plot_accuracy(epochs, train_acc, test_acc, fp = 'plot'):
    ...
    plt.grid()
    plt.title('Accuracy Curves_random')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig(os.path.join(fp, "Accuracy_Curves_random.png"))
    plt.clf()
...
model = model.to('cpu')
torch.save(model, r'models/model_random.pt')
